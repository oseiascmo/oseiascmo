...
[![Typing SVG](https://readme-typing-svg.demolab.com/?color=00bfbf&size=35&center=true&vCenter=true&width=1000&lines=Hello!+I'm+Oséias+Melo;Sankhya+ERP+%26+SQL+Developer;Building+my+Full+Stack+journey;Welcome+to+my+profile!)](https://git.io/typing-svg)
<br>
<br>
<!-- Título principal -->
...
<!-- Altere o texto abaixo para atualizar sua descrição/resumo profissional -->
 Formado em Análise e Desenvolvimento de Sistemas, atuo profissionalmente no desenvolvimento e na customização de soluções para o ecossistema Sankhya ERP, criando dashboards interativos e relatórios gerenciais estratégicos utilizando SQL, JSP e ferramentas nativas.

 Possuo também experiência acadêmica na construção de aplicações mobile multiplataforma (Ionic, Angular e Firebase) e interfaces web responsivas com HTML5, CSS3 e Bootstrap, além de formação em AWS Cloud Foundations e Cloud Practitioner.
...
Graduated in Systems Analysis and Development, I work professionally in the development and customization of solutions for the Sankhya ERP ecosystem, creating interactive dashboards and strategic management reports using SQL, JSP, and native tools.
<br><br>
I also have academic experience in building cross-platform mobile applications (Ionic, Angular, and Firebase) and responsive web interfaces with HTML5, CSS3, and Bootstrap, along with training in AWS Cloud Foundations and Cloud Practitioner.
</blockquote>
<br>
</details>
